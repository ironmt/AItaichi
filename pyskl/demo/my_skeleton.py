...
def main():
    ...
    if GCN_flag:
        ...
        GCN_nperson = format_op.get('num_person', 1)
    ...
    for video_path, label in video_list:
        ...
        for frame in vis_frames:
            cv2.putText(frame, label_map[label], (10, 30), FONTFACE, FONTSCALE, FONTCOLOR, THICKNESS, LINETYPE)
    ...
    # Save all annotations to a single pkl file
    pkl_filename = osp.join(args.out_folder, 'all_annotations.pkl')
